...
class PynguinGenerator:
    ...
    def generate_tests(self, code: str, log_callback: Optional[Callable[[str], None]] = None, algorithm: str = "DYNAMOSA") -> TestGenerationResult:
        ...
        Args:
            ...
            algorithm: Pynguin algorithm to use (DYNAMOSA, MIO, MOSA, RANDOM, WHOLE_SUITE, etc.)
        ...
        try:
            ...
            if log_callback:
                log_callback(f"Using algorithm: {algorithm}")
            ...
            # Run Pynguin with specified algorithm
            cmd = [
                "pynguin",
            ...
            if os.path.exists(test_file_path):
                ...
                return TestGenerationResult(
                    test_code="",
                    error=f"Test file not generated by Pynguin with {algorithm} algorithm",
                    method='pynguin'
                )
    ...
    def generate_tests_for_project(self, project_path: str, module_name: str, task_queue: queue.Queue, algorithm: str = "DYNAMOSA") -> None:
        ...
        try:
            ...
            if os.path.exists(test_file_path):
                ...
                task_queue.put({"type": "error", "message": f"Test file not generated. Expected: {test_filename}"})
